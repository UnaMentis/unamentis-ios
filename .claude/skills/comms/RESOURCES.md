...
4. Default to tech-general for tech topics

### Board Resolution Priority
1. Exact match
2. Alias match
3. Default: Tech Work for tech topics, Org-Business for business topics

### Common Mappings
| Input | Slack Channel | Trello Board | Trello List |
|-------|--------------|--------------|-------------|
