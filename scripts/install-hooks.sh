#!/bin/bash
# UnaMentis iOS Git Hooks Installation Script
# This script installs pre-commit hooks for quality assurance.
#
# Usage: ./scripts/install-hooks.sh
#
# What gets installed:
# - Pre-commit hook: Runs linters on staged Swift files
...
echo -e "${BLUE}========================================${NC}"
echo -e "${BLUE}UnaMentis iOS Git Hooks Installation${NC}"
echo -e "${BLUE}========================================${NC}"
echo ""
