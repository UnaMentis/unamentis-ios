#!/bin/bash
# Feature Flag Audit Script (iOS only)
# Scans Swift codebase for feature flag usage and checks for stale flags
#
# Usage:
...
# Patterns to search for feature flag usage in Swift
SWIFT_PATTERNS=(
    'isEnabled\s*\(\s*"[^"]+"\s*\)'
    'featureFlag\s*\(\s*"[^"]+"\s*\)'
...
print_header() {
    echo -e "\n${BLUE}═══════════════════════════════════════════════════════════════${NC}"
    echo -e "${BLUE}  Feature Flag Audit - UnaMentis iOS${NC}"
    echo -e "${BLUE}═══════════════════════════════════════════════════════════════${NC}\n"
}
...
check_flag_metadata() {
    ...
    # Check if metadata file is available
    local metadata_file="feature-flags/flag_metadata.json"
